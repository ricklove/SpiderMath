...
module Told.TableMath.UI {
    ...
    export class MainViewModelOLD {
        ...
        public checkForLines() {
            ...
            var lineParts: IBoardValue[] = [];

            var checkLine = function (line: IPosition[]) {

                var curLine: IBoardValue[] = [];
        ...
        private _lines: IPosition[][] = null;

        private static createLines(size: number): IPosition[][] {

            var lines: IPosition[][] = [];

            var createLines = function (getStartingPlaces: () => IPosition[], nextPlace: (p: IPosition) => IPosition) {
